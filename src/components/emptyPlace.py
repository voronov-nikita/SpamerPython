# 
# Код для так называемого "Пустого пространства"
# Суть в том, чтобы предупредить пользователя о том, что введенные им 
# данные оказываются некорректными с точки зрения программы.
# 
